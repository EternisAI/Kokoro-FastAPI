...
def make_exe():
    ...
    # Use mimalloc as Python's memory allocator for better performance.
    ...
    # Set environment variables required by the Kokoro TTS server
...
os.environ["MODEL_DIR"] = os.path.join(os.path.dirname(sys.executable), "models", "v1_0")
os.environ["VOICES_DIR"] = os.path.join(os.path.dirname(sys.executable), "voices", "v1_0")
os.environ["WEB_PLAYER_PATH"] = os.path.join(os.path.dirname(sys.executable), "web")
...
"""
    ...
    # Add required dependencies from pyproject.toml
